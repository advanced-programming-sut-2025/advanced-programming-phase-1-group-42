...
//        }
        ...
        if(controller.getClientHandler().getClientGame() == null) {
...
//        }
        if(GameMenuCommands.FORCE_TERMINATE.matcher(input) != null) {
            System.out.println(controller.forceTerminate());
        }
...
//            System.out.println(controller.purchase(matcher.group("productName"), matcher.group("count")));
        ...
        //Additional Functions
            ...
            System.out.println(controller.test());
             ...
             controller.getClientHandler().getClientPlayer().getFridge().showFridge();
