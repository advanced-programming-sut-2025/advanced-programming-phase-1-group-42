...
public enum SeedType implements GoodType {
    ...
    SeedType(String name, FarmingGoodType farmingGoodType, ArrayList<Integer> stages, int totalHarvestTime, boolean oneTime, int regrowthTime, int seasonPrice, int otherSeasonPrice, ArrayList<Season> seasons, boolean canBecomeGiant) {
        this.name = name;
